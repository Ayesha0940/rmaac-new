#!/usr/bin/env bash
# run_delay_sweep_simple_tag_predprey.sh — communication-delay attack sweep,
...
#
# Copy of run_delay_sweep.sh, scoped to simple_tag and with --benchmark added
# (see the "delay" branch of train.py's __main__ for what that unlocks).
#
# Usage (run from experiments/):
#   bash run_delay_sweep_simple_tag_predprey.sh [SEED ...]
#
# Examples:
#   bash run_delay_sweep_simple_tag_predprey.sh          # seeds 5 10 (default)
#   bash run_delay_sweep_simple_tag_predprey.sh 5 10 49   # explicit seed list
...
echo "============================================================"
echo "Delay-attack predator/prey benchmark evaluation (simple_tag only)"
...
for SEED in "${SEEDS[@]}"; do
    ...
    LOG_DIR="${SCRIPT_DIR}/logs/delay_sweep_predprey/seed${SEED}"
...
echo ""
echo "============================================================"
echo "Delay-attack predator/prey evaluation complete."
echo "Logs : ${SCRIPT_DIR}/logs/delay_sweep_predprey/seed{${SEEDS[*]}}/"
echo "CSVs : ${SCRIPT_DIR}/../../noise_sweeps/delay_sweeps/seed{${SEEDS[*]}}/predprey/*_delay_sweep.csv"
echo "============================================================"
